...
return [
    ...
    'routes' => [
        [
            ...
            'match' => [
                 ...
                 */
                'prefixes' => explode(',', env('APIDOC_ROUTE_TO_INCLUDE_PREFIX', null)),
             ...
             * Note that the route must be referenced by name here (wildcards are supported).
             */
            'exclude' => env('APP_DEBUG') ? [] : explode(',', env('APIDOC_EXCLUDE', null)),
            ...
            'apply' => [
                ...
                'headers' => [
                    ...
                    // 'Authorization' => "Basic Base64({{authUser}}:authPassword)",
                    // 'Api-Version' => 'v2',
                ],
     ...
     */
    'logo' => base_path() . '/readme/img/logo_api.jpg',
